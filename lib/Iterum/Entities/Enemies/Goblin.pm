...
package Iterum::Entities::Enemies::Goblin;
...
class Iterum::Entities::Enemies::Goblin {
    ...
    method make_decision($player_id = undef) {
        ...
        my $is_adjacent = Iterum::Components::Position::is_adjacent($ecs, $id, $player_id);
        
        # Health status affects decision-making slightly
        my $health_percent = Iterum::Components::Health::health_percentage($ecs, $id);
