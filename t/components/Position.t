...
subtest 'Distance Calculation' => sub {
    ...
    my $distance =
      Iterum::Components::Position::distance( $ecs, $entity1, $entity2 );
    is( $distance, 5, 'Distance calculated correctly (3-4-5 triangle)' );

    # Test adjacency
    ok(
        !Iterum::Components::Position::is_adjacent( $ecs, $entity1, $entity2 ),
...
subtest 'Position Validation' => sub {
    ...
    like(
        dies {
            Iterum::Components::Position::add( $ecs, $entity_id, x => 'abc' )
        },
    ...
    like(
        dies {
            Iterum::Components::Position::add( $ecs, $entity_id, y => 'def' )
        },
    ...
    like(
        dies {
            Iterum::Components::Position::move( $ecs, $entity_id, 'abc', 1 )
        },
    ...
    like(
        dies {
            Iterum::Components::Position::move( $ecs, $entity_id, 1, 'def' )
        },
